...
class BudgetProposalTest(PivxTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Test with invalid AdaPolice address")
        assert_raises_rpc_error(-5, "Invalid AdaPolice address", self.nodes[0].preparebudget,
        ...
        assert_raises_rpc_error(-8, "Invalid amount - Payment of 9.00 is less than minimum 10 APC allowed", self.nodes[0].preparebudget,
