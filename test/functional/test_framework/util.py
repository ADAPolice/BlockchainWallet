...
def initialize_datadir(dirname, n):
    ...
    with open(os.path.join(datadir, "adapolice.conf"), 'w', encoding='utf8') as f:
        f.write("regtest=1\n")
...
def get_auth_cookie(datadir):
    user = None
    password = None
    if os.path.isfile(os.path.join(datadir, "adapolice.conf")):
        with open(os.path.join(datadir, "adapolice.conf"), 'r', encoding='utf8') as f:
            for line in f:
