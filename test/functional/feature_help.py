...
"""Verify that starting adapolice with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start adapolice with -? for help text")
        ...
        self.log.info("Start adapolice with -version for version information")
