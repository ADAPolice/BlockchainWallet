...
bool CheckBlockSignature(const CBlock& block, const bool enableP2PKH)
{
    ...
    /** Each block is signed by the private key of the input that is staked. This can be either zAPC or normal UTXO
     *  zAPC: Each zAPC has a keypair associated with it. The serial number is a hash of the public key.
