...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* APC features */
        {"adapolice", "listmasternodes", &listmasternodes, true },
        {"adapolice", "getmasternodecount", &getmasternodecount, true },
        {"adapolice", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"adapolice", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"adapolice", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"adapolice", "masternodecurrent", &masternodecurrent, true },
        {"adapolice", "startmasternode", &startmasternode, true },
        {"adapolice", "createmasternodekey", &createmasternodekey, true },
        {"adapolice", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"adapolice", "listmasternodeconf", &listmasternodeconf, true },
        {"adapolice", "getmasternodestatus", &getmasternodestatus, true },
        {"adapolice", "getmasternodewinners", &getmasternodewinners, true },
        {"adapolice", "getmasternodescores", &getmasternodescores, true },
        {"adapolice", "preparebudget", &preparebudget, true },
        {"adapolice", "submitbudget", &submitbudget, true },
        {"adapolice", "mnbudgetvote", &mnbudgetvote, true },
        {"adapolice", "getbudgetvotes", &getbudgetvotes, true },
        {"adapolice", "getnextsuperblock", &getnextsuperblock, true },
        {"adapolice", "getbudgetprojection", &getbudgetprojection, true },
        {"adapolice", "getbudgetinfo", &getbudgetinfo, true },
        {"adapolice", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"adapolice", "mnfinalbudget", &mnfinalbudget, true },
        {"adapolice", "checkbudgets", &checkbudgets, true },
        {"adapolice", "mnsync", &mnsync, true },
        {"adapolice", "spork", &spork, true },
...
{
    return "> adapolice-cli " + methodname + " " + args + "\n";
}
