...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("AdaPolice adapolice-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  adapolice-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded adapolice transaction") + "\n" +
                               "  adapolice-tx [options] -create [commands]   " + _("Create hex-encoded adapolice transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded adapolice transaction
