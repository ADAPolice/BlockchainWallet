...
/* AdaPolice GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "AdaPolice"
#define QAPP_ORG_DOMAIN "adapolice.org"
#define QAPP_APP_NAME_DEFAULT "AdaPolice-Qt"
#define QAPP_APP_NAME_TESTNET "AdaPolice-Qt-testnet"
