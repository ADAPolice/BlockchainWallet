    ...
    ui(new Ui::DashboardWidget)
{
    ...
    // Staking Information
    ui->labelMessage->setText(tr("Amount of APC earned via Staking & Masternodes"));
	...
	ui->labelAmountMNRewards->setText("0 APC");
...
bool DashboardWidget::loadChartData(bool withMonthNames)
{
    ...
    chartData->amountsByCache = getAmountBy(); // pair APC, zAPC
