...
/** Utility functions used by the AdaPolice Qt UI.
 */
namespace GUIUtil
{
...
// Render APC addresses in monospace font
...
// Parse "adapolice:" URI into recipient object, return true on successful parsing
