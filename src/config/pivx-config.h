...
#define PACKAGE_BUGREPORT "https://github.com/adapolicecoin/adapolicecoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "AdaPolice Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "AdaPolice Core 2.0.1.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "adapolice"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://adapolice.finance/"
