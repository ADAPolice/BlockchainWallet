...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the adapolice repository."
  exit 1
fi
...
echo
echo 'When compiling adapoliced, run `./configure` in the following way:'
echo
echo "  export BDB_PREFIX='${BDB_PREFIX}'"
echo '  ./configure BDB_LIBS="-L${BDB_PREFIX}/lib -ldb_cxx-4.8" BDB_APCAGS="-I${BDB_PREFIX}/include" ...'
