Contributing to AdaPolice Core
============================

The AdaPolice Core project operates an open contributor model where anyone is
...
The following applies to code changes to the AdaPolice Core project, and is not to be
confused with overall AdaPolice Network Protocol consensus changes.

Whether a pull request is merged into AdaPolice Core rests with the project merge
...
Patches that change AdaPolice consensus rules are considerably more involved than
...
Where a patchset proposes to change the AdaPolice consensus, it must have been
...
The project leader is the release manager for each AdaPolice Core release.
